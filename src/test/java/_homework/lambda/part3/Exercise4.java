...
public class Exercise4 {
    ...
    private static class LazyCollectionHelper<T, R> {
        ...
        public static <T> _homework.lambda.part3.Exercise4.LazyCollectionHelper<T, T> from(List<T> list) {
            throw new UnsupportedOperationException();
        }

        public <U> _homework.lambda.part3.Exercise4.LazyCollectionHelper<T, U> flatMap(Function<R, List<U>> flatMapping) {
            throw new UnsupportedOperationException();
        }

        public <U> _homework.lambda.part3.Exercise4.LazyCollectionHelper<T, U> map(Function<R, U> mapping) {
            throw new UnsupportedOperationException();
        }
