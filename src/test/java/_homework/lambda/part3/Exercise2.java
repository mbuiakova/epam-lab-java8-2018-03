...
public class Exercise2 {
    ...
    private static class MapHelper<T> {
        ...
        public static <T> _homework.lambda.part3.Exercise2.MapHelper<T> from(List<T> source) {
            return new _homework.lambda.part3.Exercise2.MapHelper<>(source);
        }
         ...
         */
        public <R> _homework.lambda.part3.Exercise2.MapHelper<R> map(Function<T, R> mapping) {
         ...
         */
        public <R> _homework.lambda.part3.Exercise2.MapHelper<R> flatMap(Function<T, List<R>> flatMapping) {
            throw new UnsupportedOperationException();
        }
    }
